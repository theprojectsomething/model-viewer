...
import { $onResize, $scene, $tick } from '../model-viewer-base.js';
...
export const AnnotationMixin = (ModelViewerElement) => {
    ...
    class AnnotationModelViewerElement extends ModelViewerElement {
        ...
        [(_a = $annotationView, _b = $annotationRenderer, _c = $hotspotMap, _d = $mutationCallback, _e = $observer, $tick)](time, delta) {
