...
import { $onResize, $scene, $tick, toVector3D } from '../model-viewer-base.js';
...
export const AnnotationMixin = (ModelViewerElement) => {
    ...
    class AnnotationModelViewerElement extends ModelViewerElement {
        ...
        [(_a = $annotationView, _b = $annotationRenderer, _c = $hotspotMap, _d = $mutationCallback, _e = $observer, _f = $pixelPosition, $tick)](time, delta) {
