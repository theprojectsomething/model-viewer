...
export const ControlsMixin = (ModelViewerElement) => {
    ...
    class ControlsModelViewerElement extends ModelViewerElement {
        ...
        [(_a = $promptElement, _b = $promptAnimatedContainer, _c = $focusedTime, _d = $lastPromptOffset, _e = $promptElementVisibleTime, _f = $userPromptedOnce, _g = $waitingToPromptUser, _h = $shouldPromptUserToInteract, _j = $controls, _k = $zoomAdjustedFieldOfView, _l = $lastSpherical, _m = $jumpCamera, _o = $changeHandler, _p = $focusHandler, _q = $blurHandler, $syncFieldOfView)](style) {
