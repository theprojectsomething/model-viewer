...
import { EventDispatcher, Matrix4, Object3D, PerspectiveCamera, Scene, Vector3, } from 'three';
...
export class ARRenderer extends EventDispatcher {
    ...
    [(_a = $outputContext, _b = $rafId, _c = $currentSession, _d = $refSpace, _e = $viewerRefSpace, _f = $presentedScene, _g = $resolveCleanup, $postSessionCleanup)]() {
